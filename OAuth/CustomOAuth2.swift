...
class GitHubOAuth2: OAuth2Swift {
    static var sharedInstance = CustomOAuth2(
        consumerKey:    "<GITHUB_CONSUMER_KEY>",
        consumerSecret: "<GITHUB_CONSUMER_SECRET>",
        authorizeUrl: "\(AppDelegate.getAppProperty(forKey: "BaseGitHubURL"))/authorize",
        accessTokenUrl: "\(AppDelegate.getAppProperty(forKey: "BaseGitHubURL"))/access_token",
        responseType: "code"
    )
